...
/**
 * Flattens the structured portfolio data into readable text chunks for retrieval.
 * This is the single source of truth shared by the chat API, so the bot always
 * reflects whatever is shown on the site.
 */
